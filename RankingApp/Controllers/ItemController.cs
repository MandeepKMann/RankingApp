...
namespace RankingApp.Controllers
{
    ...
    public class ItemController : ControllerBase
    {
        ...
        {
            new ItemModel{Id =1, Title = "#DeadRaccoonTO", ImageId=10, Ranking=0,ItemType=1 },
            new ItemModel{Id =2, Title = "Howard Lotor", ImageId=9, Ranking=0,ItemType=1 },
            new ItemModel{Id =3, Title = "Jackson the Raccoon", ImageId=5, Ranking=0,ItemType=1 },
            new ItemModel{Id =4, Title = "Meeko", ImageId=1, Ranking=0,ItemType=1 },
            new ItemModel{Id =5, Title = "Mr.Porter", ImageId=2, Ranking=0,ItemType=1 },
            new ItemModel{Id =6, Title = "Raccacoonie", ImageId=6, Ranking=0,ItemType=1 },
            new ItemModel{Id =7, Title = "RJ", ImageId=3, Ranking=0,ItemType=1 },
            new ItemModel{Id =8, Title = "Rocket Raccoon", ImageId=4, Ranking=0,ItemType=1 },
            new ItemModel{Id =9, Title = "Sly Cooper", ImageId=8, Ranking=0,ItemType=1 },
            new ItemModel{Id =10, Title = "Tom Nook", ImageId=7, Ranking=0,ItemType=1 },
